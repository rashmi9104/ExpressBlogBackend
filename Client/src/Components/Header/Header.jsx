  ...
  return (
    <div className={`header flex w-11/12 mx-auto justify-between items-center p-1`}>
        ...
        <div className={`flex justify-between items-center gap-3 text-sm`}>
            <div className='hover:cursor-pointer transition-all hover:scale-x-105 hover:text-orange-700 hover:border-orange-700 hover:border-b-2'>About</div>
            ...
            <div className='hover:cursor-pointer transition-all hover:scale-x-105 hover:text-orange-700 hover:border-orange-700 hover:border-b-2'><CgProfile className='text-lg'/></div>
        </div>
    </div>
  )
}
